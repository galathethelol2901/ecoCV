  ...
  <div class="card-grid">
    <a class="card" href="#">
      ...
      <div class="card__content">
        <p class="card__category">LE CV</p>
        <h3 class="card__heading">pour faire connaissance</h3>
      </div>
    </a>
    <a class="card" href="#">
      ...
      <div class="card__content">
        <p class="card__category">LE FORMULAIRE </p>
        <h3 class="card__heading">pour ce </h3>
      </div>
    </a>
    <a class="card" href="#">
      ...
      <div class="card__content">
        <p class="card__category">LE JEUX</p>
        <h3 class="card__heading">pour ce detendre</h3>
      </div>
    </li>
    <a class="card" href="#">
      <div class="card__background" style="background-image: url(https://images.unsplash.com/photo-1557004396-66e4174d7bf6?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=800&q=60)"></div>
      <div class="card__content">
        <p class="card__category">LE FILM </p>
        <h3 class="card__heading">en traveaux </h3>
      </div>
    </a>
  <div>
</section>
